...
//use innerhtml sparingly, it can cause you to wipe out your code in the dom. if you want to wipe it out use = if you want to add on to it use += but it is better to just use appendchild.
